...
class MetaLearning():
    ...
    def fit(self, Y, fh, forecast_dim=0):
        ...
        self.meta_learner.fit(X=meta_features, y=labels)  # type numpy.ndarray, numpy.ndarray
